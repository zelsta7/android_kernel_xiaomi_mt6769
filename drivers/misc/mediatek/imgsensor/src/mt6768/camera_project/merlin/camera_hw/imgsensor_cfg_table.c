...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_UNDEF},
...
#endif
#if defined(GC02M1_MACRO_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1_MACRO_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(GC02M1_MACRO_SUNNY_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1_MACRO_SUNNY_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(OV2680_SUNNY_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV2680_SUNNY_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 10},
			{DOVDD, Vol_1800, 10},
