...
#include "s5kgm1sp_sunny_mipiraw_sensor.h"
...
#endif
static kal_uint16 s5kgm1sp_sunny_table_write_cmos_sensor(
...
//	LOG_INF("cxc s5kgm1sp sunny_sensor_init MULTI_WRITE\n");
	s5kgm1sp_sunny_table_write_cmos_sensor(
		addr_data_pair_init_s5kgm1sp_sunny,
		sizeof(addr_data_pair_init_s5kgm1sp_sunny) /
		sizeof(kal_uint16));
#else
...
UINT32
S5KGM1SP_SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
