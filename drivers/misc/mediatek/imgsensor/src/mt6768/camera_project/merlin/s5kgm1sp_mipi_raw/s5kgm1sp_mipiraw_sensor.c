...
#include "s5kgm1sp_mipiraw_sensor.h"
...
#endif
static kal_uint16 s5kgm1sp_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kgm1sp[] = {
	0x6028, 0x4000,
	0x0000, 0x0009,
	0x0000, 0x08D1,
	0x6010, 0x0001,
...
static void sensor_init(void)
{
	...
	mdelay(3);
#if MULTI_WRITE
//	LOG_INF("cxc s5kgm1sp sensor_init MULTI_WRITE\n");
	s5kgm1sp_table_write_cmos_sensor(
		addr_data_pair_init_s5kgm1sp,
		sizeof(addr_data_pair_init_s5kgm1sp) / sizeof(kal_uint16));
#else
			...
			if (vendor_id == 0x07) {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info
			("s5kgm1sp_ofilm i2c 0x%x, sid 0x%x vid: 0x%x\n",
