...
#include "gc5035_qtech_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc5035_qtech_camera_sensor"
#define LOG_1 LOG_INF("GC5035_QTECH_MIPI, 2LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035_QTECH_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	get_byte = (read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1);
	get_byte = get_byte + 1;
	return get_byte;
}
...
UINT32 GC5035_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
