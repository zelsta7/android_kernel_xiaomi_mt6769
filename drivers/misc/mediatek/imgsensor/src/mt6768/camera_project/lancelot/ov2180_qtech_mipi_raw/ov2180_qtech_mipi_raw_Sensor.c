...
#define PFX "OV2180_QTECH_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV2180_QTECH_SENSOR_ID,		//OV2180MIPI_SENSOR_ID,  /*sensor_id = 0x2180*/ //record sensor id defined in Kd_imgsensor.h
...
static void capture_setting(kal_uint16 curretfps)
{
	...
	//write_cmos_sensor(0x0100, 0x00);
	//write_cmos_sensor(0x3002, 0x00); //0x6c  0x0e00
	//write_cmos_sensor(0x3016, 0x1c); //0x10  0x2800
	//write_cmos_sensor(0x3018, 0x44);
	//write_cmos_sensor(0x3020, 0x00);
	//write_cmos_sensor(0x3080, 0x02);
	//write_cmos_sensor(0x3082, 0x37);
...
UINT32 OV2180_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
