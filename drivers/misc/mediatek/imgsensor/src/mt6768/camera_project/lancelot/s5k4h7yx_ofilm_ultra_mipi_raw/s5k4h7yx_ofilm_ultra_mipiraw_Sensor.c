...
#include "s5k4h7yx_ofilm_ultra_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_OFILM_ULTRA_SENSOR_ID,
...
kal_uint16 otp_4h7_ultra_read_cmos_sensor(kal_uint32 addr)
{
...
unsigned char S5K4H7_ultra_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7_ultra_write_cmos_sensor(u16 addr, u32 para)
{
	char pusendcmd[3] = {
		(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF) };
...
static kal_uint32 return_sensor_id(void)
{
	...
	get_byte = get_byte + 3;
	LOG_INF("s5k_ultra_ofilm get_byte = %d\n", get_byte);
	return get_byte;
...
UINT32 S5K4H7YX_OFILM_ULTRA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT
						**pfFunc)
{
