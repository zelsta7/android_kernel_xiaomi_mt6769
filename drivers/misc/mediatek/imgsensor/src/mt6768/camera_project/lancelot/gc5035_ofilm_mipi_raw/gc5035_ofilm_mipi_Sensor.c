...
#include "gc5035_ofilm_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc5035_ofilm_camera_sensor"
#define LOG_1 LOG_INF("GC5035_OFILM_MIPI, 2LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035_OFILM_SENSOR_ID,
	...
	.normal_video = {
		.pclk = 87600000,
		.linelength = 1460,
		.framelength = 2000, //2008-->2000, FPS 29.8-->30
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1296,
		.grabwindow_height = 972,
...
static struct imgsensor_struct imgsensor = {
	...
	.ihdr_en = 0,
	.i2c_write_id = 0x6e,
	.current_ae_effective_frame = 2, //长曝光生效帧数。若N+1生效，值为1；N+2生效，值为2
};
...
static void set_dummy(void)
{
	...
	write_cmos_sensor(0xfd, 0x2c);//alan add 200512
...
static void set_shutter(kal_uint64 shutter)
{
	...
	unsigned int value_81 = 0;
	unsigned int value_82 = 0;
	unsigned int value_83 = 0;
	...
	//LOG_INF("Exit Long Exposure! shutter = %d, framelength = %d, cal_shutter = %d\n", shutter, imgsensor.frame_length, cal_shutter);
	} else{
		LOG_INF("Enter Long Exposure! shutter = %d", shutter);
			bNeedSetNormalMode = KAL_TRUE;
			imgsensor.ae_frm_mode.frame_mode_1 = IMGSENSOR_AE_MODE_SE;
			imgsensor.ae_frm_mode.frame_mode_2 = IMGSENSOR_AE_MODE_SE;
			imgsensor.current_ae_effective_frame = 2;
		switch (shutter) {
		case 17999://shutter和value均适配完毕
			value_81 = 0x00;
			value_82 = 0x01;
			value_83 = 0xd3;
			break;
		...
		case 1799964:
			...
			break;
		default:
			pr_debug("LZM ERROR! Shutter = %d, does not match any values!", shutter);
	...
	write_cmos_sensor(0xfd, 0x2c);
	write_cmos_sensor(0xef, 0x02);
	write_cmos_sensor(0x81, value_81);
	write_cmos_sensor(0x82, value_82);
	write_cmos_sensor(0x83, value_83);
	write_cmos_sensor(0xef, 0x00);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain_flat == 0) {
		...
		write_cmos_sensor(0xfd, 0x2d);//alan add 200512
		write_cmos_sensor(0xef, 0x00);
		write_cmos_sensor(0xb6, GC5035_AGC_Param[gain_index][1]);
		temp_gain = reg_gain * Dgain_ratio / GC5035_AGC_Param[gain_index][0];
		write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x0f);
...
UINT32 GC5035_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
